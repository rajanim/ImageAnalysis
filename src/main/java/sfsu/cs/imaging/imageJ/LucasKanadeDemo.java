 ...
 * @author WB
 */
public class LucasKanadeDemo implements PlugInFilter {
    ...
    public void run(ImageProcessor ip) {
        ...
        System.out.println("Step 1: Create the search image I:");

        FloatProcessor I = ip.convertToFloatProcessor();

        // Step 2: Create the (empty) reference image $R$:
        System.out.println("Create the (empty) reference image $R$:");
        ...
        System.out.println("        // Step 4: Create the Lucas-Kanade matcher (forward or inverse):\n");
        ...
        System.out.println("        // Step 5: Calculate the initial mapping Tinit from (centered) R -> Q:\n");
        ProjectiveMapping Tinit = matcher.getReferenceMappingTo(Q);
        IJ.log("Tinit = " + Matrix.toString(Tinit.getWarpParameters()));

        System.out.println("        // Step 6: Calculate the real mapping from (centered) R -> QQ (for validation only):\n");
        ...
        // --------------------------------------------------------------------------
        System.out.println("// Step 7: Initialize the matcher and run the matching loop:");
